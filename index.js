 ...
 */
const firstrow= { //letrehozom az elso sor ertekeinek az objektumat
    region:'Amerika', //regionnek string eteket adunk
    year:'1860-1865', //yearnek string eteket adunk
    event:'polgárháború' //eventnek string eteket adunk
}


/**
 * @type {region:string, year:string, event:string, secondyear:string, secondevent:string} secondrow objektum string valtozo amiben a tablazat masodik soranak adatai vannak
 */
const secondrow= { //letrehozom a masodik sor ertekeinek az objektumat
    region:'Európa', //regionnek string eteket adunk
    year:'1914 június 28', //year1nek string eteket adunk
    event:'merénylet szarajevóban', //event1nek string eteket adunk
    secondyear:'1914 július 28', //year2nek string eteket adunk
    secondevent:'A mohácsi csata' //event2nek string eteket adunk
}

/**
 * @type {region:string, year:string, event:string, secondyear:string, secondevent:string} thirdrow objektum string valtozo amiben a tablazat harmadik soranak adatai vannak
 */
const thirdrow= { //letrehozom a harmadik sor ertekeinek az objektumat
    region:'Oroszország', //regionnek string eteket adunk
    year:'1917', //year1nek string eteket adunk
    event:'Oroszországi forradalom és bolsevik hatalomátvétel', //event1nek string eteket adunk
    secondyear:'1933', //year2nek string eteket adunk
    secondevent:'Szovjetúnió megalakulása' //event2nek string eteket adunk
}
...
firsttd.textContent=firstrow.region //beallitom a tr elso soranak elso elem szoveget a megfelelo valtozora
...
secondtd.textContent=firstrow.year //beallitom a tr elso soranak masodik elem szoveget a megfelelo valtozora
...
thirdtd.textContent=firstrow.event //beallitom a tr elso soranak harmadik elem szoveget a megfelelo valtozora
...
secondtrfirsttd.textContent=secondrow.region //beallitom a tr masodik soranak elso elem szoveget a megfelelo valtozora
...
secondtrsecondtd.textContent=secondrow.year //beallitom a tr masodik soranak masodik elem szoveget a megfelelo valtozora
...
secondtrthirdtd.textContent=secondrow.event //beallitom a tr masodik soranak harmadik elem szoveget a megfelelo valtozora
...
secondtrfourthtd.textContent=secondrow.secondyear //beallitom a tr masodik soranak negyedik elem szoveget a megfelelo valtozora
...
secondtrfifthtd.textContent=secondrow.secondevent //beallitom a tr masodik soranak otodik elem szoveget a megfelelo valtozora
...
thirdtrfirsttd.textContent=thirdrow.region //beallitom a tr harmadik soranak elso elem szoveget a megfelelo valtozora
...
thirdtrsecondtd.textContent=thirdrow.year //beallitom a tr harmadik soranak masodik elem szoveget a megfelelo valtozora
...
thirdtrthirdtd.textContent=thirdrow.event //beallitom a tr harmadik soranak harmadik elem szoveget a megfelelo valtozora
...
thirdtrfourthtd.textContent=thirdrow.secondyear //beallitom a tr harmadik soranak negyedik elem szoveget a megfelelo valtozora
...
thirdtrfifthtd.textContent=thirdrow.secondevent //beallitom a tr harmadik soranak otodik elem szoveget a megfelelo valtozora
